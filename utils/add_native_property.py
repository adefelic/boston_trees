...
native_trees_from_book = [
	...
	# "Gleditsia triacanthos", invasive in ma?
	"Gymnocladus dioicus",
	"Halesia carolina",
	"Ilex montana",
	"Ilex opaca",
...
all_native = ['Abies balsamea', 'Acer nigrum', 'Acer pensylvanicum', 'Acer rubrum', 'Acer saccharinum', 'Acer saccharum', 'Acer x freemanii', 'Aesculus flava', 'Aesculus glabra', 'Aesculus pavia', 'Aesculus sylvatica', 'Amelanchier arborea', 'Amelanchier canadensis', 'Amelanchier laevis', 'Aralia spinosa', 'Asimina triloba', 'Betula alleghaniensis', 'Betula lenta', 'Betula nigra', 'Betula papyrifera', 'Betula populifolia', 'Carpinus caroliniana', 'Carya cordiformis', 'Carya illinoinensis', 'Carya laciniosa', 'Carya ovata', 'Celtis occidentalis', 'Cercis canadensis', 'Cercis canadensis var. alba', 'Chamaecyparis thyoides', 'Cladrastis kentukea', 'Cornus alternifolia', 'Cornus florida', 'Cotinus obovatus', 'Crataegus crus-galli', 'Crataegus mollis', 'Crataegus phaenopyrum', 'Crataegus punctata', 'Crataegus viridis', 'Diospyros virginiana', 'Fagus grandifolia', 'Fraxinus americana', 'Fraxinus nigra', 'Fraxinus pennsylvanica', 'Fraxinus quadrangulata', 'Gymnocladus dioicus', 'Halesia carolina', 'Hamamelis virginiana', 'Ilex montana', 'Ilex opaca', 'Juglans cinerea', 'Juglans nigra', 'Juniperus virginiana', 'Larix laricina', 'Liquidambar styraciflua', 'Liriodendron tulipfera', 'Liriodendron tulipifera', 'Magnolia acuminata', 'Magnolia fraseri', 'Magnolia macrophylla', 'Magnolia tripetala', 'Magnolia virginiana', 'Malus angustifolia', 'Malus coronaria', 'Malus glaucescens', 'Malus ioensis', 'Morus rubra', 'Myrica cerifera', 'Nyssa sylvatica', 'Ostrya virginiana', 'Oxydendrum arboreum', 'Picea glauca', 'Picea mariana', 'Pinus banksiana', 'Pinus echinata', 'Pinus resinosa', 'Pinus rigida', 'Pinus strobus', 'Pinus virginiana', 'Platanus occidentalis', 'Populus deltoides', 'Populus grandidentata', 'Populus tremuloides', 'Prunus americana', 'Prunus pennsylvanica', 'Prunus pensylvanica', 'Prunus virginiana', 'Ptelea trifoliata', 'Quercus alba', 'Quercus bicolor', 'Quercus coccinea', 'Quercus imbricaria', 'Quercus laurifolia', 'Quercus lyrata', 'Quercus macrocarpa', 'Quercus montana', 'Quercus muehlenbergii', 'Quercus palustris', 'Quercus phellos', 'Quercus prinus', 'Quercus rubra', 'Quercus shumardii', 'Quercus velutina', 'Quercus x schuettei', 'Salix amygdaloides', 'Salix discolor', 'Salix nigra', 'Sambucus canadensis', 'Sassafras albidum', 'Sorbus americana', 'Stewartia ovata', 'Styrax americanus', 'Taxodium distichum', 'Thuja occidentalis', 'Tilia americana', 'Tsuga canadensis', 'Ulmus rubra', 'Viburnum lentago', 'Viburnum prunifolium', 'Viburnum rufidulum']
...
with fiona.open("static/data/treekeeper_street_trees.geojson") as src:
	...
	with fiona.open(
		"static/data/boston_trees_with_native_column.geojson",
		mode="w",
		crs=src.crs,
		driver="GeoJSON",
		schema=dst_schema
